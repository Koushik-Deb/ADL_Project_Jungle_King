...
//to connect to the server
    ...
    public void render(float delta) {
        ...
        if(!controller.isPause) {
            ...
            //to change the world
            if(player.b2body.getPosition().x>121 && world1 == false && world2 == false)
            {
                world1 = true;
                scorecounter();
                worldcreator();
            }
            else if(player.b2body.getPosition().x>121 && world1 == true && world2 == false)
            {
                world2 = true;
                scorecounter();
                worldcreator();
